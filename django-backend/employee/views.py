...
# prefix = "Act like a venture coach and give me 8 actionable steps in json format which includes the step number with key name as 'step_number', category with key name as 'category', multiple elaborated tasks with key name as 'keys', team positions with key name as 'team_position', multiple resources that can help at each step like organizations, to help me in each step located around Niagara Falls, Buffalo (provide website links if possible) for my startup. Start up idea is: "
